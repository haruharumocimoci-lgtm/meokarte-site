...
export default function Tokushoho() {
  const rows: { label: string; value: React.ReactNode }[] = [
    ...
    { label: "販売URL", value: "https://misegao.com" },
    {
      ...
      value: (
        <ul className="space-y-1.5">
          ...
          <li>独自ドメイン：年額 5,000円（税込・ドメイン代込み）</li>
        </ul>
      ),
    },
    {
    ...
    },
    {
      label: "お支払い時期",
      value:
        "月額プランはお申し込み時に初回分を決済し、以降1か月ごとに自動更新・自動決済されます。独自ドメインはお申し込み時に初回分を決済し、以降1年ごとに自動更新・自動決済されます。一括料金（通販ページ追加）はお申し込み時に決済されます。現金でのお支払いの場合は、ご契約時にお支払いいただきます（月額プランは6か月分または12か月分の前払い）。",
    },
    {
      label: "サービス提供時期",
      value:
